		...
		switch(ch)
		{
			case 1:
				...
				while(1)
				{
					...
					switch(ch)
					{
						case 1: //New Coordinator details
							adding_new_coordinator_to_file();
							c_root = new_coordinator(c_root);
							break;
						case 2: //Updating the coordinator details
							...
							break;
						case 3: //Deletion of the coordinator
							printf("enter user-id \n");
							scanf("%s",user_id);
							c_root = delete_coordinator(user_id , c_root);
							save_coordinator_data_into_file(c_root);
							break;
						case 4: //Displaying the list of coordinator
							display_coordinator(c_root);
							break;
						case 5: //going back to previous menu
							exit_flag_1 =1;
...
//Creating the list for coordinator details
...
//Creation of the new coordiantor
...
//Finding length to delete the coordinator
